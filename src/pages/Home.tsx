  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-card/30 border-y border-border/40">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollAnimationWrapper animation="slideUp" delay={0}>
            ...
            <ScrollAnimationWrapper animation="slideUp" delay={150}>
              <div className="text-center space-y-3 p-6 rounded-xl hover:bg-card/50 transition-colors">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <ScrollAnimationWrapper animation="fadeIn" className="relative z-10">
