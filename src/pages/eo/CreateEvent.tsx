...
import { Plus, Trash, Image as ImageIcon, Calendar } from 'lucide-react';
...
export default function CreateEvent() {
    ...
    const { createEvent, isLoading } = useEOStore();
    ...
    const [ticketCategories, setTicketCategories] = useState<TicketCategory[]>([
        { name: 'Regular', price: 0, stock: 100, benefits: [] },
    ]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (result.success) {
            toast({
                ...
                description: 'Event Anda kini sudah published.',
            });
    ...
    return (
        <div className="container mx-auto py-8 max-w-4xl">
            <div className="mb-8">
                ...
                <p className="text-muted-foreground">Isi detail event konser dan atur kategori tiket Anda.</p>
            </div>
